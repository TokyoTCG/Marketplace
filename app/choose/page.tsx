    ...
    <div style={{ backgroundColor: '#1a1a1c', minHeight: '100vh', color: '#ffffff', fontFamily: "'Segoe UI', system-ui, sans-serif", position: 'relative' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '80px 24px', textAlign: 'center' }}>
          <h1 style={{ fontSize: '32px', fontWeight: '800', marginBottom: '8px' }}>Waar zoek je naar?</h1>
          <p style={{ color: '#aaaaaa', fontSize: '15px', marginBottom: '64px' }}>Kies een categorie om te beginnen</p>

          <div style={{ display: 'flex', justifyContent: 'center', gap: '64px', alignItems: 'flex-end' }}>
            <a href="/browse" style={{ textDecoration: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
              <img src="/card-greedent.jpg" alt="Raw card"
                style={{ width: '210px', height: '310px', objectFit: 'cover', objectPosition: 'center top', borderRadius: '12px', transition: 'transform 0.2s', cursor: 'pointer' }}
            ...
            <a href="/graded" style={{ textDecoration: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
              <img src="/card-psa.jpg" alt="PSA graded card"
