...
const conditionColor: Record<string, string> = { M: '#4ade80', NM: '#a67abf', Excellent: '#60a5fa', Good: '#facc15', Played: '#f87171' };
...
export default function CardDetail({ card }: { card: any }) {
  ...
  const filtered = listings.filter(l => { if (activeCondition === 'All') return true; const map: Record<string,string> = { M: 'Mint', NM: 'NM', EX: 'Excellent', GD: 'Good', PL: 'Played' }; return l.condition === activeCondition || l.condition === map[activeCondition]; });
